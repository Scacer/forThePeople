...
newImage.src = "images/WorldHungerMap.png"
...
const image6 = new ImageClicker2("images/Hunger1Image.jpeg","Unsafe food","very poor housing conditions leading to a poor standard of living along with use of kerosne makes it a high fire risk")
const image7 = new ImageClicker2("images/Hunger2Image.jpeg","Low food avalibility","very poor housing conditions leading to a poor standard of living along with use of kerosne makes it a high fire risk")
...
const image4 = new ImageClicker1("images/Hunger3Image.jpeg","Unsafe Cooking methods","this is just used for testing as it need to test it","this is just used for testing as it need to test it","this is just used for testing as it need to test it")
const image5 = new ImageClicker1("images/Hunger4Image.jpeg","SafeWater Drinking","this is just used for testing as it need to test it","this is just used for testing as it need to test it","this is just used for testing as it need to test it")
