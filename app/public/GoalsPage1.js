...
newImage.src = "images/PovertyWorldMap.jpeg"
...
const image6 = new ImageClicker2("images/Povertyimage1.jpeg","Unsafe water usage","very poor housing conditions leading to a poor standard of living along with use of kerosne makes it a high fire risk")
const image7 = new ImageClicker2("images/PovertySlums.jpeg","Awful housing conditions","very poor housing conditions leading to a poor standard of living along with use of kerosne makes it a high fire risk")
...
const image4 = new ImageClicker1("images/CookingFood.jpeg","Unsafe Cooking methods","this is just used for testing as it need to test it","this is just used for testing as it need to test it","this is just used for testing as it need to test it")
const image5 = new ImageClicker1("images/SafeWater.jpeg","SafeWater Drinking","this is just used for testing as it need to test it","this is just used for testing as it need to test it","this is just used for testing as it need to test it")
